...
\begin{itemize}
    \item \textbf{Lunghezza della molla a riposo ($l_0$):} \dots\dots mm
    \item \textbf{Lunghezza della molla a piattello scarico ($l_s$):} \dots\dots mm
\end{itemize}
...
\begin{tabular}{cc}
\hline
\textbf{Massa applicata $m_i$ (g)} & \textbf{Lunghezza misurata $\ell_i$ (mm)} \\ \hline
\dots & \dots \\
\dots & \dots \\
\dots & \dots \\
\dots & \dots \\
